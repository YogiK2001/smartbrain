...
const onSubmit = () => {
    fetch("https://api.clarifai.com/v2/models/" + MODEL_ID + "/versions/" + MODEL_VERSION_ID + "/outputs", returnRequestOptions(inputUrl))
      ...
      .then(response => {
        if (response) {
          fetch('https://smartbrain-api-azih.onrender.com/image', {
            method: 'put',
...
const params = {
    ...
    interactivity: {
        ...
        modes: {
            ...
            bubble: {
                distance: 200,    // The distance at which the bubbles will repel particles
                size: 20,         // The size of the bubbles
                duration: 2,      // The duration of the bubble animation in seconds
